...
(function () {
  ...
  function renderEvaluation() {
    ...
    evalContainer.innerHTML = `
      ...
      <!-- Two-column layout: Questionnaire left, Conversation right -->
      <div class="eval-layout">
        ...
        <div class="eval-main">
          <div class="card">
            ...
            <div class="faces-description">
              <strong>Instructions:</strong> Rate how you perceive the
        ...
        <div class="eval-sidebar">
          <div class="card floating-conv">
            <div class="card-title"><span class="icon">💬</span> Conversation (${convSessionId})</div>
            <div class="conversation-area" id="conv-area">
              ${conversations.length === 0
        ? '<div class="empty-state"><p>No conversation data.</p></div>'
