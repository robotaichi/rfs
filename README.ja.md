...
筑波大学 理工情報生命学術院 システム情報工学研究群 知能機能システム学位プログラム の博士課程3年生。HRI系の研究を行っている田中文英研究室に所属。父親・母親・娘といったロボット家族を作って一人暮らしの高齢者の孤独感を軽減する研究を行っている。JST Spring採択。大学のDXを推進するプロジェクトにも従事。
